    ...
    d3.json("data/samples.json").then((data) =>{
        ...
        var data3 = [{
                ...
                gauge: {
                    axis:{range: [0,9]},
                    steps: [
                        {range: [0,1], color: "rgb(102, 204, 51)"},
                        {range: [1,2], color: "rgb(137,215,39)"},
                        {range: [2,3], color: "rgb(199,236,19)"},
                        {range: [3,4], color: "rgb(255,248,0)"},
                        {range: [4,5], color: "rgb(255,181,0)"},
                        {range: [5,6], color: "rgb(255,107,0)"},
                        {range: [6,7], color: "rgb(231,55,0)"},
                        {range: [7,8], color: "rgb(215,22,0)"},
                        {range: [8,9], color: "rgb(204, 0, 0)"},                         
                    ]
                }                
            }
        ];        
